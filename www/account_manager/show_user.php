    ...
    <div class="col-sm-7">
        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                ...
                <button class="btn btn-warning pull-right align-self-end" style="margin-top: auto;"
                        onclick="show_delete_user_button();">Delete account
                </button>
                <form action="/<?php print $THIS_MODULE_PATH; ?>/index.php" method="post"><input type="hidden"
                                                                                                 name="delete_user"
                                                                                                 value="<?php print urlencode($username); ?>">
                    <button class="btn btn-danger pull-right invisible" id="delete_user">Confirm deletion</button>
                </form>
            </div>
            <ul class="list-group">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="" method="post">
                        ...
                        foreach ($attribute_map as $key => $value) {
                            ...
                            <div class="form-group">
                                <label for="<?php print $key; ?>"
                                       class="col-sm-3 control-label"><?php print $value; ?></label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="<?php print $key; ?>"
                                           name="<?php print $key; ?>" value="<?php print $user[0][$key][0]; ?>">
                                </div>
                            </div>
                            <?php
                        }
                        ...
                        <div class="form-group" id="password_div">
                            ...
                            <div class="col-sm-1">
                                <input type="button" class="btn btn-sm" id="password_generator"
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="list-arrows col-md-1 text-center">
                        ...
                        <button id="submit_members" class="btn btn-info" disabled type="submit"
                                onclick="update_form_with_groups()">Save
                        </button>
                    </div>
