...
if (isset($_POST['create_account'])) {
    ...
    if ((!is_numeric($_POST['pass_score']) or $_POST['pass_score'] < 3) and $ACCEPT_WEAK_PASSWORDS != TRUE) {
        $weak_password = TRUE;
    }
    if (isset($email) and !is_valid_email($email)) {
        $invalid_email = TRUE;
    }
    ...
    if (isset($_POST['send_email']) and isset($email) and $can_send_email == TRUE) {
            ...
            if ($admin_setup == TRUE) {
                ...
                if (!$member_add) { ?>
                    <div class="alert alert-warning">
                        <p class="text-center"><?php print $creation_message; ?>. Unfortunately adding it to the admin
                            group failed.</p>
                    </div>
                    <?php
                }
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body text-center">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <?php if ($admin_setup == TRUE) { ?><input type="hidden" name="setup_admin_account"
                                                               value="true"><?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input tabindex="1" type="text" class="form-control" id="first_name"
                                   name="first_name" <?php if (isset($first_name)) {
                                print " value='$first_name'";
                            } ?>
                                   onkeyup="update_username(); update_email(); check_email_validity(document.getElementById('email').value)">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input tabindex="3" type="text" class="form-control" id="last_name"
                                   name="last_name" <?php if (isset($last_name)) {
                    ...
                    <div class="form-group" id="username_div">
                        ...
                        <div class="col-sm-6">
                            <input tabindex="3" type="text" class="form-control" id="username"
                                   name="username" <?php if (isset($username)) {
                                print " value='$username'";
                            } ?>
                                   onkeyup="check_entity_name_validity(document.getElementById('username').value,'username_div'); update_email(); check_email_validity(document.getElementById('email').value)">
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="email_div">
                        ...
                        <div class="col-sm-6">
                            <input tabindex="4" type="text" class="form-control" id="email"
                                   name="email" <?php if (isset($email)) {
                                print " value='$email'";
                            } ?>
                                   onkeyup="auto_email_update = false; check_email_validity(document.getElementById('email').value)">
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="password_div">
                        ...
                        <div class="col-sm-6">
                            <input tabindex="5" type="text" class="form-control" id="password" name="password"
                                   onkeyup="back_to_hidden('password','confirm');">
                        </div>
                        <div class="col-sm-1">
                            <input tabindex="7" type="button" class="btn btn-sm" id="password_generator"
                                   onclick="random_password();" value="Generate password">
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="confirm_div">
                        ...
                        <div class="col-sm-6">
                            <input tabindex="6" type="password" class="form-control" id="confirm" name="password_match"
                                   onkeyup="check_passwords_match()">
                        </div>
                    </div>
                    ...
                    <?php if ($can_send_email == TRUE and $admin_setup != TRUE) { ?>
                        <div class="form-group" id="send_email_div">
                            ...
                            <div class="col-sm-6">
                                <input tabindex="8" type="checkbox" class="form-check-input" id="send_email_checkbox"
                                       name="send_email" disabled> Email these credentials to the user?
                            </div>
                        </div>
                    <?php } ?>
