...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-heading clearfix">
            ...
            <form action="/<?php print $THIS_MODULE_PATH; ?>/groups.php" method="post"><input type="hidden"
                                                                                              name="delete_group"
                                                                                              value="<?php print $group_cn; ?>">
                <button class="btn btn-danger pull-right invisible" id="delete_group">Confirm deletion</button>
            </form>
        </div>
        <ul class="list-group">
                ...
                <div class="row">
                    ...
                    <div class="list-arrows col-md-1 text-center">
                        ...
                        <button id="submit_members" class="btn btn-info" disabled type="submit"
                                onclick="update_form_with_users()">Save
                        </button>
                    </div>
